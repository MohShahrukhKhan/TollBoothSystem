...
public class GlobalExceptionHandler {
	...
	@ExceptionHandler(VehicleOwnerException.class)
	public ResponseEntity<MyErrorDetails> appointmentExceptionHandler(VehicleOwnerException ex, WebRequest req) {
		MyErrorDetails err = new MyErrorDetails(LocalDateTime.now(), ex.getMessage(), req.getDescription(false));
		return new ResponseEntity<MyErrorDetails>(err, HttpStatus.BAD_REQUEST);
	}

	@ExceptionHandler(ownerNotFoundException.class)
	public ResponseEntity<MyErrorDetails> AppointmentNotFoundExceptionHandler(ownerNotFoundException ex, WebRequest req) {
		MyErrorDetails err = new MyErrorDetails(LocalDateTime.now(), ex.getMessage(), req.getDescription(false));
